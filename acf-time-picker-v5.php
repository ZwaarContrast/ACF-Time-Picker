...
class acf_field_time_picker extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*  var message = acf._e('time_picker', 'error');
		*/
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-time_picker', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-time_picker');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-time_picker', "{$dir}css/input.css" ); 
		wp_enqueue_style('acf-input-time_picker');
